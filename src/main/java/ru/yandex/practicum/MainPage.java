...
public class MainPage {
    ...
    //массив локаторов из текстовых ответов на вопрос раздела "Вопросы о важном"
    ...
    //метод для получения контента из текстовых ответов раздела "Вопросы о важном"
    public String getAnswersImportantQuestions(int listIndex) {
        By locator = answersImportantQuestionsArray[listIndex];
        return driver.findElement(locator).getText();
    }

    //метод для сравнения контента ответов с ожидаемыми ответами
